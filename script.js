...
function showForecast(daily) {
    ...
    const endTemp = Math.round(temps[6]);
    const diff = endTemp - todayTemp;

    let text;
    if (diff > 0) {
        text = `\u2600\uFE0F \u041F\u0440\u043E\u0433\u043D\u043E\u0437 \u043D\u0430 \u043F\u043E\u0442\u0435\u043F\u043B\u0435\u043D\u0438\u0435: \u0441\u0435\u0433\u043E\u0434\u043D\u044F ${todayTemp}\u00B0C, \u043A \u043A\u043E\u043D\u0446\u0443 \u043D\u0435\u0434\u0435\u043B\u0438 ${endTemp}\u00B0C (+${diff}\u00B0)`;
    } else if (diff < 0) {
        text = `\u2744\uFE0F \u041F\u0440\u043E\u0433\u043D\u043E\u0437 \u043D\u0430 \u043F\u043E\u0445\u043E\u043B\u043E\u0434\u0430\u043D\u0438\u0435: \u0441\u0435\u0433\u043E\u0434\u043D\u044F ${todayTemp}\u00B0C, \u043A \u043A\u043E\u043D\u0446\u0443 \u043D\u0435\u0434\u0435\u043B\u0438 ${endTemp}\u00B0C (${diff}\u00B0)`;
    } else {
        text = `\u{1F321}\uFE0F \u0422\u0435\u043C\u043F\u0435\u0440\u0430\u0442\u0443\u0440\u0430 \u0441\u0442\u0430\u0431\u0438\u043B\u044C\u043D\u0430 \u0432\u0441\u044E \u043D\u0435\u0434\u0435\u043B\u044E: ${todayTemp}\u00B0C`;
    }

    rec.innerHTML = `<p>${text}</p>`;
